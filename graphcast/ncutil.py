...
if __name__ == '__main__':
    ...
    mean = nc.Dataset('../weights/testdata_and_normvector/mean_by_level.nc')
    std = nc.Dataset('../weights/testdata_and_normvector/stddev_by_level.nc')
    diff = nc.Dataset('../weights/testdata_and_normvector/diffs_stddev_by_level.nc')
    ...
    np.savez_compressed('../weights/para_5mesh_13level_1deg/NormVector.npz', **norm_fact)
